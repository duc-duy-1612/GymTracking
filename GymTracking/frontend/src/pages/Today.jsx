        ...
        {!recLoading && (
          <div style={{ marginBottom: '10px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '12px' }}>
              <p className="fitbit-card-title" style={{ margin: 0, fontSize: '0.85rem', color: 'var(--fitbit-muted)' }}>
                AI gợi ý nhanh
              </p>
              {aiBusy && <span className="text-muted" style={{ fontSize: '0.8rem' }}>Đang phân tích…</span>}
            </div>
            {aiReco ? (
              <div style={{ marginTop: '8px' }} className="fitbit-card card-dark">
                <div className="fitbit-card-body" style={{ width: '100%' }}>
                  <div style={{ whiteSpace: 'pre-wrap', lineHeight: 1.45, fontSize: '0.9rem' }}>{aiReco}</div>
                </div>
              </div>
            ) : null}
          </div>
